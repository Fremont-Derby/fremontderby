...
- **#337 Close season** — PR #412 ships an explicit audited **Close season** action on `/season-setup` after competitive completion while preserving league history. Cancel/Archive/safe-delete remain distinct lifecycle actions under #414; richer Publish/Close readiness presentation remains #338. Do not create a second season-lifecycle page.
...
- `/season-setup` — league-director selected-season lifecycle management under Admin → League Management, including explicit audited **Close season** after PR #412/#337. Richer Publish/Close readiness stays #338; distinct Cancel/Archive/safe-delete actions stay #414
