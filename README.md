...
- **#335 private captain contact** — PR #401 establishes Profile as the self-service home for a player's private league contact phone. Normal players may maintain it optionally; an active captain must keep a contact number on file. Admin-only detail/readiness remains private, and assignment/activation enforcement plus canonical Admin wiring stay on #335/#372.
