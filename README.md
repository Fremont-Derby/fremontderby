...
- `/lineup` — current authoritative captain lineup workflow; #371 consolidates minimum match-night preparation into Score without changing blind-lineup rules; Test Drive reuse of the production lineup component is tracked by #388
- `/scorecard` — canonical flexible league-night hub. PRs #422/#424 ship local-Today default plus human-readable date, scoring-team, team-matchup, and revealed-race selectors from the existing authorized scorable-match read model; remaining #371 work is captain pre-score preparation, actual-play-date semantics, and final phone/browser validation
