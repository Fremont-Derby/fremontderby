...
Normal public season read models exclude seasons classified for QA purpose after PR #561. Schedule, Standings, and Prizes keep their existing page ownership; PR #566 now gives all three one shared lifecycle-aware default policy among eligible league seasons while preserving a valid explicit season selection.
