...
export function collectDomainEnvDrift({ wranglerConfig } = {}) {
  ...
  // PRODUCTION_DNS_HOSTS must be production only and complete
  ...
  // LANE_CUSTOM_DOMAINS ↔ host map + service naming
  ...
  // diagnose bindings cover every public host
  for (const hostname of Object.keys(hostMap)) {
