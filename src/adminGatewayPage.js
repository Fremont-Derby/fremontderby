...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}[hidden]{display:none!important}body{margin:0;min-height:100vh;background:radial-gradient(circle at 85% 8%,rgba(229,189,80,.10),transparent 28%),linear-gradient(180deg,#0b1711,#101713 46%,#0c1210)}button{font:inherit;cursor:pointer}
