export const STANDINGS_CONTEXT_MISSION = {
  ...
  world: 'player',
  persona: 'Player',
  context: 'You play on more than one team and need the requested team's place, not your individual rank.',
  action: 'Find the requested team's standing and keep it distinct from individual standings after a season switch.',
  entryMode: 'natural',
  estimatedSeconds: 45,
  ...
  assertions: [
    ...
    { id: 'requested-team-clear', type: 'human', text: 'The requested team's rank stayed identifiable among distractor teams.' },
