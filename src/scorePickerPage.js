...
<body>
  <main class="app">
    <header class="head"><h1>Score a match</h1><div class="muted">Choose a revealed matchup your team is allowed to score. No tokens or database IDs required.</div></header>
