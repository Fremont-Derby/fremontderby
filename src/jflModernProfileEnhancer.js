const modernProfileStyle = `<style data-fd-modern-profile-style>
  ...
  button:disabled{opacity:1!important;background:var(--fd-profile-disabled-bg)!important;color:var(--fd-profile-disabled-ink)!important;border-color:#7c8b82!important;cursor:not-allowed!important}.primary:disabled{background:var(--fd-profile-disabled-bg)!important;color:var(--fd-profile-disabled-ink)!important}.ghost:disabled,.danger:disabled{background:var(--fd-profile-disabled-bg)!important;color:var(--fd-profile-disabled-ink)!important;border-color:#7c8b82!important}[data-fd-modern-profile="true"] .primary,[data-fd-modern-profile="true"] .primary:hover,[data-fd-modern-profile="true"] .primary:focus-visible{background:var(--fd-profile-green)!important;color:#fff!important;border-color:var(--fd-profile-green-dark)!important}[data-fd-modern-profile="true"] .primary:active{background:var(--fd-profile-green-dark)!important;color:#fff!important;border-color:#021f13!important}body[data-fd-player-surface="profile"] [data-fd-modern-profile="true"] button:disabled,body[data-fd-player-surface="profile"] [data-fd-modern-profile="true"] .primary:disabled,body[data-fd-player-surface="profile"] [data-fd-modern-profile="true"] .ghost:disabled,body[data-fd-player-surface="profile"] [data-fd-modern-profile="true"] .danger:disabled{opacity:1!important;background:var(--fd-profile-disabled-bg)!important;color:var(--fd-profile-disabled-ink)!important;border-color:#7c8b82!important}[data-fd-modern-profile="true"] button:disabled *{color:inherit!important}[data-fd-modern-profile="true"] .status[data-tone="ok"]{background:var(--fd-profile-success-bg)!important;color:var(--fd-profile-success-ink)!important;border:1px solid #fff!important}
