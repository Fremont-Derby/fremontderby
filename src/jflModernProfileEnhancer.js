const modernProfileStyle = `<style data-fd-modern-profile-style>
  ...
  @media(max-width:640px){.app{width:min(100% - 20px,920px)!important;padding-top:14px!important}.profile-head{grid-template-columns:1fr!important}.rating{width:106px!important}.actions{grid-template-columns:1fr!important}.actions button{width:100%!important}.admin-actions{grid-template-columns:1fr!important}.panel-head{padding:0 14px!important}.stack{padding:14px!important}}
  @media(forced-colors:active){.panel,[data-profile-identity],button,input,a{border:2px solid CanvasText!important}[data-profile-identity] .panel-head,.status{background:Canvas!important;color:CanvasText!important}}
</style>`;
