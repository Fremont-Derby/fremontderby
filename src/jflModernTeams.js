...
export const jflModernTeamsStyles = `
  ...
  .fd-teams__filters{display:grid;grid-template-columns:repeat(3,1fr);gap:7px;padding:6px;border:2px solid #929f96;border-radius:14px;background:#d9e0db}.fd-teams__filters button{min-height:48px;border:2px solid #7e8b82;border-radius:10px;background:#fff;color:#183b2c;font:inherit;font-weight:950}.fd-teams .fd-teams__filters button[aria-pressed="true"]{border:3px solid #011d12!important;background:var(--fd-green-dark)!important;color:#fff!important;box-shadow:0 0 0 3px #b8d9c7,0 4px 10px rgba(3,60,37,.35)!important}.fd-teams .fd-teams__filters button[aria-pressed="true"]::before{content:'✓ ';font-weight:1000}
...
(() => {
  ...
  const activeTeamApplicationStatuses = new Set(['applied','deferred','approved_pending_roster','ready','confirmed']);
