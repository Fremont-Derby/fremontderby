...
<body>
  <main>
    ...
    <section class="card">
      ...
      <div class="next"><a class="button primary" href="/teams">See current teams</a><a class="button secondary" href="/players">Player directory</a><a class="button secondary" href="/rules">Read the rules</a></div>
    </section>
