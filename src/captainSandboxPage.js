...
<body><main class="app">
  ...
  <section class="panel feedback"><h3>Tell us what was confusing</h3><div class="muted">War Games captures the current captain workflow state with your comment. This draft stays separate from competitive records.</div><textarea maxlength="1000" placeholder="What worked, what did not, or what would make captain duties easier?" data-feedback-text></textarea><div class="muted" style="margin-top:8px" data-feedback-context></div><div class="actions"><button class="primary" data-feedback-save>Save feedback draft</button><button class="ghost" data-feedback-clear>Clear feedback</button></div><div class="feedback-status" data-feedback-status aria-live="polite"></div></section>
</main>
<script>
