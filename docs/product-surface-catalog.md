...
| `/teams` | Player / captain | Find, join, create, and manage teams and roster relationships | Canonical team/roster home. It may show contextual league-night shortcuts, but Schedule/Availability/Lineup/Score remain separate canonical functions. Phone-width management tables now stay inside the viewport with wrapped content and full-width touch actions after PR #290; #131 is complete |
...
| Player / captain | Find/create/join/manage team relationships | `/teams` | Implemented; mobile no-horizontal-scroll contract shipped | #131, #181, #182, PR #290 | Teams is the canonical roster/membership home; league-night shortcuts are secondary links only. Phone management tables now wrap long values, keep actions in the same viewport, and use >=44px full-width touch actions without horizontal panel scrolling |
...
- PR #288 codified a durable no-horizontal-scroll mobile data rule; PR #290 then applied it to `/teams`, removing the forced 680px mobile table/horizontal panel pattern and adding regression coverage. #131 is complete and no duplicate IA/runtime issue is needed.
...
- #131 — Teams canonical team/directory story completed; PR #290 supplies the required no-horizontal-scroll mobile management-table contract and regression proof.
